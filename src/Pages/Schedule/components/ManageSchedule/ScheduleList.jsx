  ...
  return (
    <div className={styles.container}>
      <div className={styles.currentSchedule}>
        <h3 className={styles.title}>{current ? current.name : "Select A Schedule"}</h3>
      </div>
      ...
      {!current ? (
        <div className={styles.scheduleList}>
          ...
          {schedules?.map((schedule, index) => {
            return (
              <div key={index} className={`list-item--md ${styles.columns}`} onClick={() => handleViewSchedule(schedule)}>
