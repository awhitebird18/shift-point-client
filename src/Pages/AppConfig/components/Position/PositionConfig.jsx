...
const PositionConfig = ({ position, departmentList, earningList, setPositionList, premiumList, showModal }) => {
  ...
  return (
    <Form layout="vertical">
      ...
      <Form.Item>
        ...
        >
          <Select defaultValue="" onChange={handleDepartment} value={currentPosition.departmentId}>
            {departmentOptions && departmentOptions.length > 0 ? departmentOptions : ""}
          </Select>
        </Form.Item>
        <Form.Item label="Earning" style={{ display: "inline-block", width: "200px" }}>
          <Select defaultValue="" onChange={handleEarning} value={currentPosition.earningId}>
