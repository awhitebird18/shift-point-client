...
import { convertToHours12, days, months } from "../../functions/timesheetUtils";
      ...
      <div className={styles.breakHeader}>
        <Space direction="vertical" style={{ display: "block" }}>
          <span style={{ display: "inline" }} type="secondary">
            ...
            {", "}
            {timecardDisplay && `${timecardDisplay.start ? timecardDisplay.start : ""} - ${timecardDisplay.end ? timecardDisplay.end : ""}`}
          </span>
